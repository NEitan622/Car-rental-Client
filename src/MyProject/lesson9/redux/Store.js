...
const initialState = {
    ...
    currentUser: {},
    products: [
        { name: 'sunhat', price: '15', pic: '1' },
        { name: 'ice cream', price: '10', pic: '2' },
        { name: 'watermelon', price: '20', pic: '3' },
        { name: 'tawel', price: '20', pic: '4' },
        { name: 'tube', price: '10', pic: '5' },
        { name: 'sunglasses', price: '10', pic: '6' },
        { name: 'goggles', price: '10', pic: '7' }
    ]
}
