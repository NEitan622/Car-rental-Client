...
export const CheeseCakes = () => {
    ...
    return <>
        ...
        {selectedItem &&  <Select arr={addList} set={setSelectedAdd} text='תוספת'></Select>}
        {/* {selectedItem && !selectedAdd && <MultipleSelect list={addList} set={setSelectedAdd}></MultipleSelect>} */}
